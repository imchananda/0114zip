      ...
      <div className="min-h-screen bg-[var(--color-bg)] pt-24 px-4 pb-12">
        <div className="max-w-2xl mx-auto">
          ...
          <button
            ...
            className="w-full mb-6 py-3 bg-gradient-to-r from-[#6cbfd0] to-[#fbdf74] text-[#141413] rounded-xl font-medium hover:opacity-90 transition-opacity"
          >
              ...
              >
                ...
                <div className="divide-y divide-[var(--color-border)]">
                  {social.links.map((link) => (
                    ...
                    >
                      <div>
                        <span className="text-sm text-[var(--color-text)] group-hover:text-[#6cbfd0] transition-colors">
                          {link.label}
                        </span>
                        {link.sub && (
                      ...
                      <span className="text-[var(--color-muted)] group-hover:text-[#6cbfd0] text-sm transition-colors">↗</span>
                    </a>
                  ))}
                </div>
              </motion.div>
