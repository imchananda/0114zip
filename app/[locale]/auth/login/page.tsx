    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-[var(--color-bg)]">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--color-text-muted)] text-sm mt-2">เข้าสู่ระบบ</p>
        </div>
        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-6 shadow-[0px_4px_24px_rgba(0,0,0,0.05)]">
          ...
          <div className="flex items-center gap-3 my-5">
            ...
            <span className="text-xs text-[var(--color-text-muted)]">หรือใช้อีเมล</span>
            <div className="flex-1 h-px bg-[var(--color-border)]" />
          </div>
        ...
        <p className="text-center mt-6 text-sm text-[var(--color-text-muted)]">
          ยังไม่มีบัญชี?{' '}
          <Link href="/auth/register" className="text-[#6cbfd0] hover:underline">
            สมัครสมาชิก
          </Link>
        </p>
