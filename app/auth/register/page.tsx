    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-[var(--color-bg)]">
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span className="text-xs text-[var(--color-muted)]">หรือสมัครด้วยอีเมล</span>
          <div className="flex-1 h-px bg-[var(--color-border)]" />
        </div>
...
function GoogleLoginButton() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg hover:border-[#1E88E5]/50 transition-all disabled:opacity-60"
    >
