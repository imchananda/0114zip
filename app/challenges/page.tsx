...
const TYPE_CONFIG = {
  quiz: { label: 'ทายคำถาม', emoji: '🧠', color: '#1E88E5' },
  vote: { label: 'โหวต', emoji: '🗳️', color: '#FDD835' },
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)] pt-20 px-4 pb-16">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Login nudge */}
        {!user && (
          <div className="bg-gradient-to-r from-[#1E88E5]/10 to-[#FDD835]/10 border border-[#1E88E5]/30 rounded-xl p-4 mb-6 text-center">
            <p className="text-sm text-[var(--color-muted)]">
              <Link href="/auth/login" className="text-[#1E88E5] hover:underline font-medium">เข้าสู่ระบบ</Link>
                ...
                >
                  <Link href={`/challenges/${ch.slug}`}>
                    <div className={`relative bg-[var(--color-surface)] border rounded-2xl p-5 transition-all hover:shadow-lg hover:-translate-y-0.5 ${
                        ...
                        : 'border-[var(--color-border)] hover:border-[#1E88E5]/50'
                    }`}>
                      {/* Badge */}
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="text-right shrink-0">
                          <span className="text-lg font-bold text-[#FDD835]">+{ch.reward_points}</span>
