        ...
        {user ? (
          <div className="bg-[var(--color-surface)] rounded-xl border border-[var(--color-border)] p-4 mb-6">
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-[#1E88E5] to-[#1565C0] text-white rounded-lg text-sm disabled:opacity-40 hover:opacity-90 transition-opacity"
              >
                {posting ? '...' : '📤 โพส'}
              </button>
            </div>
          ...
          <div className="bg-[var(--color-surface)] rounded-xl border border-[var(--color-border)] p-4 mb-6 text-center">
            <p className="text-[var(--color-muted)] text-sm">
              <Link href="/auth/login" className="text-[#1E88E5] hover:underline">เข้าสู่ระบบ</Link> เพื่อโพสข้อความ
            </p>
          </div>
        )}
            ...
            {posts.map((post) => (
              <div key={post.id} className="bg-[var(--color-surface)] rounded-xl border border-[var(--color-border)] p-4">
                ...
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#1E88E5] to-[#FDD835] flex items-center justify-center text-white text-xs font-medium overflow-hidden">
