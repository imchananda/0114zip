...
interface HeroSlidesManagerProps {
  ...
  setThemeFilter: (value: 'all' | 'light' | 'dark') => void;
  displaySlides: HeroSlide[];
  openNew: () => void;
  load: () => Promise<void>;
  moveSlide: (id: string, dir: -1 | 1) => Promise<void>;
  toggleEnabled: (slide: HeroSlide) => Promise<void>;
  openEdit: (slide: HeroSlide) => void;
  deleteSlide: (slide: HeroSlide) => Promise<void>;
  editing: HeroSlide | null;
  isNew: boolean;
  closeModal: () => void;
  setEditing: Dispatch<SetStateAction<HeroSlide | null>>;
            ...
            return (
              <div key={slide.id}
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button onClick={() => { void moveSlide(slide.id, -1); }} disabled={idx === 0}
                  ...
                  <button onClick={() => { void moveSlide(slide.id, 1); }} disabled={idx === displaySlides.length - 1}
                  ...
                  <button onClick={() => { void toggleEnabled(slide); }}
                  ...
                  <button onClick={() => { void deleteSlide(slide); }}
            ...
            <div className="px-6 py-5 space-y-5 overflow-y-auto flex-1 min-h-0">
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <input ref={fileRef} type="file" accept="image/jpeg,image/png,image/webp,image/gif" className="hidden" onChange={(e) => { void handleFilePick(e); }} />
                </div>
